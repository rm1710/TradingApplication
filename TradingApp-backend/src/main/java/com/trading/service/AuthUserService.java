...
public class AuthUserService {
    ...
    public AuthResponse signin(UserEntity user) {
        ...
        if(user.getTwoFactorAuth().isEnabled()) {
        	...
        	TwoFactorOTPEntity oldTwoFactorOTP= twoFactorOtpService.findByUserId(authUser.getId());
        	
        	if(oldTwoFactorOTP!=null) {
        		twoFactorOtpService.deleteTwoFactorOtp(oldTwoFactorOTP);
        	}
        	
        	TwoFactorOTPEntity newTwoFactorOTP= twoFactorOtpService.createTwoFactorOTP(authUser, otp, jwt);
	...
	public AuthResponse VerifyOTP(String otp, String id) throws Exception {
		TwoFactorOTPEntity twoFactorOTP= twoFactorOtpService.findById(id);
